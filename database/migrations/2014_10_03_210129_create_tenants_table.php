...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenants', function (Blueprint $table) {
            ...
            //Status tenant (se inativo 'N' ele perde o acesso ao sistema)
            $table->enum('active', ['Y', 'N'])->default('Y');

            //Subscription
            $table->date('subscription')->nullable(); //Data que se inscreveu
            $table->date('expire_at')->nullable(); //Data que expira o acesso
            $table->string('subscription_id', 255)->nullable(); //Identificado de Gateway de pagamento
